...
if n < 3: 
    ...
    arrey = []
    for i in range(n):
        arrey.append(int(input('Введите количество ягод: ')))

    first_num = arrey[0] + arrey[1] + arrey[n-1]
    last_num = arrey[0] + arrey[n-2] + arrey[n-1]
    max_num = 0
    ...
    for i in range(1, n-1):
        if max_num < arrey[i] + arrey[i-1] + arrey[i+1]:
            max_num = arrey[i] + arrey[i-1] + arrey[i+1]
    print(max_num)